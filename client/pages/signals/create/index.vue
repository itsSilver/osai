  ...
  data() {
    return {
      ...
      famiglia_macchina_options: [
        ...
        { value: 'Neo place Sold Top', text: 'Neo place Sold Top' },
        { value: 'Neo Thermostep', text: 'Neo Thermostep' },
        { value: 'Neo Router Modula', text: 'Neo Router Modula' },
        { value: 'Neo Handler Modula', text: 'Neo Handler Modula' },
        ...
        { value: 'Neo Loader/Unloader', text: 'Neo Loader/Unloader' },
        ...
        { value: 'Non Identificabile', text: 'Non Identificabile' },
      ],
