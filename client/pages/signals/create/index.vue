          ...
          <b-overlay :show="show" rounded="sm">
            <b-form @submit.prevent="onSubmit" class="create-solution-form">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control input-create" id="id_alarme" v-model="form.id_allarme"
              ...
              <div class="form-group row">
                <label for="immag2" class="col-sm-2 col-form-label create-label">Image 1</label>
                <div class="col-sm-10">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <b-form-select v-model="form.famiglia_macchina" :options="famiglia_macchina_options"></b-form-select>
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 col-form-label create-label">Under Family machine</label>
                <div class="col-sm-10">
                  <b-form-select v-model="form.sottofamiglia_macchina" :options="sottofamiglia_macchina_options">
                  </b-form-select>
                </div>
              </div>
              <div class="form-group row">
