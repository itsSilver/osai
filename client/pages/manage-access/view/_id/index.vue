            ...
            <div class="d-flex gap-4">
              <ul class="
                ...
                <li class="nav-actions-color mx-2" v-if="showPermissionList === false">
                  <i class="fas fa-plus pr-2 fas-main-color px-14-format"></i>
                  View User
                </li>
          ...
          <b-overlay :show="show" rounded="sm">
            <b-form @submit.prevent="onSubmitPermission" class="create-solution-form">
              ...
              <div class="form-group">
                <PermissionsList :dataTable="dataPermission" @data-send="dataSend" :viewMode="viewMode" />
              </div>

              <div class="form-group row">
                <div class="col-sm-10">
                  <b-button type="submit" class="mx-2 button-format" @click="
                    $router.push(`/manage-access/update/${$route.params.id}`)
                  ">
