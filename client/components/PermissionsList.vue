<template>
  <div>
    <b-list-group-item v-if="!viewMode">
      <b-form-checkbox class="checkthis" id="checkall" v-model="selectAll" :disabled="viewMode">Select All Permissions
      </b-form-checkbox>
    </b-list-group-item>
    ...
    <div class="permissions-list">
      <b-card v-for="(list, index) in formatedArray" :key="index">
        ...
        <b-list-group v-for="data in list" :key="data.id">
          <b-list-group-item>
            <b-form-checkbox v-model="selected" :value="data.id" :disabled="viewMode">{{ data.name }}</b-form-checkbox>
          </b-list-group-item>
        </b-list-group>
      </b-card>
    </div>
