  ...
  <div>
    <b-overlay :show="show" rounded="sm">
      <o-table :data="dataTable" :bordered="true" :striped="true" mobile-cards paginated :per-page="perPage"
        ...
        <o-table-column field="total_occorrenze" label="Related Occurrence" position="centered" v-slot="props"
          searchable sortable :visible="showTotalOccurrence">
      ...
      <SeeOccurrences v-if="showOccurrenceTable" :tableValue="tableValue" :alarmId="alarmId" @close="hideModal()" />
    </b-overlay>
  </div>
</template>
